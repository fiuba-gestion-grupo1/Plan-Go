  ...
  return (
    ...
    >
      ...
      <div className="mb-3">
        ...
        />
        <small className="form-text text-muted">
          Agrega cualquier comentario o preferencia especial para personalizar
          tu itinerario (máximo 500 caracteres)
        </small>
      </div>

      <div className="alert alert-info" role="alert">
        <strong>Nota:</strong> El itinerario se generará considerando tus
        preferencias de viaje configuradas en tu perfil. Asegúrate de haberlas
        completado para obtener mejores resultados. ESTO PUEDE TARDAR UN
        MOMENTO, NO CIERRES LA PÁGINA HASTA QUE SE COMPLETE.
      </div>
