...
export default function PublicationDetailModal({
  ...
  useEffect(() => {
    setIsFav(pub.is_favorite || false);
  }, [pub?.id, pub?.is_favorite]);
  ...
  async function submitComment(e, reviewId) {
    ...
    try {
      const newComment = await request(
        `/api/publications/reviews/${reviewId}/comments`,
        {
          method: "POST",
          token,
  ...
  async function handleSubmitReport(e) {
    ...
    try {
      await request(
        `/api/publications/${pub.id}/reviews/${reportingReview.id}/report`,
        {
          method: "POST",
          token,
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: 600, maxHeight: "90vh", width: "90%" }}
      >
        ...
        <div
          className="p-3"
          style={{ overflowY: "auto", maxHeight: "calc(90vh - 70px)" }}
        >
          <div className="mb-3">
            {pub.photos?.length > 0 ? (
              <div
          ...
          <div className="mb-3">
            ...
            <div className="mb-3">
              <h6 className="mb-2" style={{ color: "#3A92B5" }}>
                📍 Ubicación
              </h6>
              <p className="mb-2">
                {pub.address ? `${pub.address}, ` : ""}
                {pub.city}
                {pub.province ? `, ${pub.province}` : ""}
            ...
            {pub.duration_min && (
              <div className="mb-3">
                ...
                <p className="mb-0">
                  {pub.duration_min < 60
                    ? `${pub.duration_min} minutos`
                    : `${Math.round(pub.duration_min / 60)} horas`}
                </p>
              </div>
            )}
                ...
                {list.map((r) => (
                  <li key={r.id} className="border rounded-3 p-3 mb-2">
                          ...
                          title={
                            isPremium
                              ? r.is_liked_by_me
                                ? "Quitar me gusta"
                                : "Dar me gusta"
                              : "Solo usuarios premium pueden dar me gusta"
                          }
                    ...
                    >
                      ...
                      {isLoggedIn && (
                        <form
                          onSubmit={(e) => submitComment(e, r.id)}
            ...
            <form onSubmit={handleSubmitReport}>
              ...
              >
                <p>
                  ...
                  <strong>{reportingReview.author_username}</strong>:
                </p>
                ...
                <div className="form-check">
                  <input
                    ...
                    checked={reportReason === "Es spam o publicidad"}
                  />
                ...
                <div className="form-check">
                  <input
                    ...
                    onChange={(e) => setReportReason(e.target.value)}
                    checked={
                      reportReason === "Contenido inapropiado u ofensivo"
                    }
                  />
                ...
                <div className="form-check">
                  <input
                    ...
                    onChange={(e) => setReportReason(e.target.value)}
                    checked={
                      reportReason === "Discurso de odio o discriminación"
                    }
                  />
                ...
                <div className="form-check">
                  <input
                    ...
                    onChange={(e) => setReportReason(e.target.value)}
                    checked={
                      reportReason === "No es relevante para la publicación"
                    }
                  />
                  <label className="form-check-label" htmlFor="reason4">
                    No es relevante para la publicación
                  </label>
                </div>
                <div className="form-check">
                  <input
                    ...
                    value="Otro"
                    onChange={(e) => setReportReason(e.target.value)}
                    checked={reportReason === "Otra razón"}
                  />
